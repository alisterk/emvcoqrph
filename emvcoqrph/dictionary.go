...
var ADDITIONAL_FIELD = map[string]string{
...
var MERCHANT_ACCOUNT_INFORMATION = map[string]string{
...
var MERCHANT_INFORMATION = map[string]string{
...
var UNRESERVED_TEMPLATE = map[string]string{
...
var INITIAL_METHOD = map[string]string{
